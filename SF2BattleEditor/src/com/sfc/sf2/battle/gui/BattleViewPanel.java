...
public class BattleViewPanel extends AbstractViewPanel<BattleLayoutPanel> {
    ...
    public void checkForTooManyMapsprites() {
        boolean tooMany = false;
        Battle battle = layoutPanel.getBattle();
        if (battle == null) {
            tooMany = false;
        } else {
            int count = battle.getSpriteset().getAllies().length;
            Enemy[] enemies = battle.getSpriteset().getEnemies();
            for (int i = 0; i < enemies.length; i++) {
                if (enemies[i].getEnemyData() != null && enemies[i].getEnemyData().isIsSpecialSprite()) {
                    count += 4;
                } else {
                    count += 1;
                }
        ...
        infoButtonTooManySprites.setVisible(tooMany);
    }
    ...
    private void initComponents() {
        ...
        infoButtonTooManySprites = new com.sfc.sf2.core.gui.controls.InfoButton();
        ...
        infoButtonTooManySprites.setIcon(flatOptionPaneWarningIcon1);
        infoButtonTooManySprites.setMessageText("<html><b>Warning:</b> Possibly too many mapsprites in battle.<br>Battles (and maps) only support a limited number of entities on the map at once, this limit is 32. Going over this limit may cause instability during the battle.<br><br>How to determine if you have too many mapsprites:<br>- Each Ally placeholder entry will count as 1 mapsprite (assuming there are enough allies in the party to enter the battle).<br>- Each regular-sized Enemy entry will count as 1 mapsprite.<br>- Large Enemy entries (e.g. Zeon or Taros) will count as 4 mapsprites.");
        infoButtonTooManySprites.setText("");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(infoButtonTooManySprites, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jCheckBoxRegions)
                        .addComponent(jCheckBoxPoints))
                    .addComponent(infoButtonTooManySprites, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
    ...
    private com.sfc.sf2.core.gui.controls.InfoButton infoButtonTooManySprites;
