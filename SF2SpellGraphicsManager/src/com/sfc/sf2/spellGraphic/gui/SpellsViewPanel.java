 ...
 * @author TiMMy
 */
public class SpellsViewPanel extends AbstractViewPanel<AbstractLayoutPanel> {

    /**
     * Creates new form ViewPanel
     */
    public SpellsViewPanel() {
        super();
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBoxScale.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1x" }));
